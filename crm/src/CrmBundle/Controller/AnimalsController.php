...
class AnimalsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $animals = $em->getRepository('CrmBundle:Animals')->findAll();
    ...
    {
        $animal = new Animals();
        $form = $this->createForm('CrmBundle\Form\AnimalsType', $animal);
    ...
    {
        $deleteForm = $this->createDeleteForm($animal);
        $editForm = $this->createForm('CrmBundle\Form\AnimalsType', $animal);
