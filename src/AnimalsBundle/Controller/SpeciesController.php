...
use AnimalsBundle\Entity\Species;
...
class SpeciesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $species = $em->getRepository('AnimalsBundle:Species')->findAll();
    ...
    {
        $species = new Species();
        $form = $this->createForm('AnimalsBundle\Form\SpeciesType', $species);
    ...
    {
        $deleteForm = $this->createDeleteForm($species);
        $editForm = $this->createForm('AnimalsBundle\Form\SpeciesType', $species);
